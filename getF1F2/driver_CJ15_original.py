...
def mainFLQ2():
  ...
  flq = open("Output_original/FL_fixQ2_cj15.txt","w")
  for Q2 in FLQ2list:
    for i in range(0,74):
      W = 1.07+0.01*i
      nu = (W**2 - M**2 + Q2)/(2*M)
...
def mainFLW():
  FLWlist = [1.23,1.42,1.52,1.71]
  flw = open("Output_original/FL_fixW_cj15.txt","w")
  for W in FLWlist:
    for i in range(0,51):
      Q2 = 0.5+0.1*i
      nu = (W**2 - M**2 + Q2)/(2*M)
...
def mainF2trunc():
  f2 = open("Output_original/F2_trunc_cj15.txt","w")
  f1 = open("Output_original/F1_trunc_cj15.txt","w")
  fl = open("Output_original/FL_trunc_cj15.txt","w")
...
def mainTMC():
  f1a = open("Output_original/F1TMC_abs_cj15.txt","w")
  f1r0 = open("Output_original/F1TMC_rel_uncorr_cj15.txt","w")
  f1rOPE = open("Output_original/F1TMC_rel_OPE_cj15.txt","w")
  f2a = open("Output_original/F2TMC_abs_cj15.txt","w")
  f2r0 = open("Output_original/F2TMC_rel_uncorr_cj15.txt","w")
  f2rOPE = open("Output_original/F2TMC_rel_OPE_cj15.txt","w")
  fla = open("Output_original/FLTMC_abs_cj15.txt","w")
  flr0 = open("Output_original/FLTMC_rel_uncorr_cj15.txt","w")
  flrOPE = open("Output_original/FLTMC_rel_OPE_cj15.txt","w")
  for j in range(1,90):
    x = j/100.
    Q2=2.
    rho = (1.0 + 4.0*x**2*M**2/Q2)**0.5
